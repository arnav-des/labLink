        ...
        <div>
          {
            dataList?.map((certificate)=>{
              ...
              <>
                ...
                <h3>Purchase Date: {moment(certificate.sendData.purchaseDate).format("MMM Do YY")}</h3>
                <h3>Last Service Date: {moment(certificate.sendData.lastService).format("MMM Do YY")}</h3>
                <h3>Next Service Date: {moment(certificate.sendData.nextService).format("MMM Do YY")}</h3>
